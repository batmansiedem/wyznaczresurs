...
INPUT_LABELS = {
    ...
    'sposob_pracy':         'Sposób pracy wózka specjalizowanego',
    'operator':             'Ilość operatorów',
    'ilosc_moto':           'Ilość motogodzin od początku eksploatacji',
    'procent_jazda':        'Procent motogodzin przypadających na jazdę',
    'procent_podnosnik':    'Procent motogodzin przypadających na pracę jako podnośnik koszowy',
    'procent_bumar':        'Efektywny czas pracy podestu ruchomego [%]',
    # Punkty LDR (Wózek specjalizowany)
    'p_1': 'Udział cykli dla zasięgu 0-20% i wys. podnoszenia 80-100%',
    'p_2': 'Udział cykli dla zasięgu 20-40% i wys. podnoszenia 80-100%',
    'p_3': 'Udział cykli dla zasięgu 40-60% i wys. podnoszenia 80-100%',
    'p_4': 'Udział cykli dla zasięgu 60-80% i wys. podnoszenia 80-100%',
    'p_5': 'Udział cykli dla zasięgu 80-100% i wys. podnoszenia 80-100%',
    'p_6': 'Udział cykli dla zasięgu 0-20% i wys. podnoszenia 60-80%',
    'p_7': 'Udział cykli dla zasięgu 20-40% i wys. podnoszenia 60-80%',
    'p_8': 'Udział cykli dla zasięgu 40-60% i wys. podnoszenia 60-80%',
    'p_9': 'Udział cykli dla zasięgu 60-80% i wys. podnoszenia 60-80%',
    'p_10': 'Udział cykli dla zasięgu 80-100% i wys. podnoszenia 60-80%',
    'p_11': 'Udział cykli dla zasięgu 0-20% i wys. podnoszenia 40-60%',
    'p_12': 'Udział cykli dla zasięgu 20-40% i wys. podnoszenia 40-60%',
    'p_13': 'Udział cykli dla zasięgu 40-60% i wys. podnoszenia 40-60%',
    'p_14': 'Udział cykli dla zasięgu 60-80% i wys. podnoszenia 40-60%',
    'p_15': 'Udział cykli dla zasięgu 80-100% i wys. podnoszenia 40-60%',
    'p_16': 'Udział cykli dla zasięgu 0-20% i wys. podnoszenia 20-40%',
    'p_17': 'Udział cykli dla zasięgu 20-40% i wys. podnoszenia 20-40%',
    'p_18': 'Udział cykli dla zasięgu 40-60% i wys. podnoszenia 20-40%',
    'p_19': 'Udział cykli dla zasięgu 60-80% i wys. podnoszenia 20-40%',
    'p_20': 'Udział cykli dla zasięgu 80-100% i wys. podnoszenia 20-40%',
    'p_21': 'Udział cykli dla zasięgu 0-20% i wys. podnoszenia 0-20%',
    'p_22': 'Udział cykli dla zasięgu 20-40% i wys. podnoszenia 0-20%',
    'p_23': 'Udział cykli dla zasięgu 40-60% i wys. podnoszenia 0-20%',
    'p_24': 'Udział cykli dla zasięgu 60-80% i wys. podnoszenia 0-20%',
    'p_25': 'Udział cykli dla zasięgu 80-100% i wys. podnoszenia 0-20%',
...
OUTPUT_LABELS = {
    ...
    'U_WSK':                     ('Maksymalna liczba cykli U_WSK',          'cykle'),
    'moto_efektywne':            ('Zredukowana ilość motogodzin',           'mth'),
    'moto_rok':                  ('ilość motogodzin przypadających na rok',  'mth/rok'),
    'T_WSK':                     ('Maksymalna liczba motogodzin T_WSK',      'mth'),
    'F_X':                       ('Współczynnik F',                         '[-]'),
    'ilosc_cykli':               ('Ilość odbytych cykli',                   'cykle'),
    'ilosc_cykli_rok':           ('ilość cykli przypadających na rok',      'cykle/rok'),
    ...
    'wsp_km':                    ('Współczynnik Km',                        '[-]'),
    'stan_obciazenia':           ('Stan obciążenia',                        ''),
    'data_prognoza':             ('Symulacja daty osiągnięcia resursu *',   ''),
    'resurs_prognoza_dni':       ('Ilość dni pozostałych do osiągnięcia resursu *', 'dni'),
    'ldr':                       ('Współczynnik L_dr',                      '[-]'),
    'hdr':                       ('Współczynnik H_dr',                      '[-]'),
